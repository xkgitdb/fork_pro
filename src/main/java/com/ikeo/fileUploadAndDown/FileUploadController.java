...
public class FileUploadController {
	...
	public String index(){
		...
		return "fileUploadAndDownPage/index";
	}

	@RequestMapping("/registerForm")
	public String registerForm(){
		return "fileUploadAndDownPage/registerForm";
	}
	...
	public String upload(HttpServletRequest request,
		...
		if(!file.isEmpty()){
			...
			return "fileUploadAndDownPage/success";
		}else{
			return "fileUploadAndDownPage/error";
		}
	}
	...
	public String register(HttpServletRequest request,
		...
		if(!user.getHeadPortrait().isEmpty()){
			...
			return "fileUploadAndDownPage/userInfo";
		}else{
			return "fileUploadAndDownPage/error";
		}
	}
